...
data_gen <- function(seedd)
{
  ...
  A = c(group1$A, group2$A, group3$A, group4$A)
  s = c(group1$s, group2$s, group3$s, group4$s)
  k = c(group1$k, group2$k, group3$k, group4$k)
  ...
  filename = paste0("data_scen2_seed", seedd)
